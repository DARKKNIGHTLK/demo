...
public class SysLogAspect {
     ...
     * 切点表达式:   execution(...)
     */
    @Pointcut("execution(public * com.javaboy.demo.controller.UserController.getInfo())")
    public void logPointCut() {}

    @Pointcut("@annotation(com.javaboy.demo.annotation.SysLog)")
    public void logPointCut2() {}

    @Around("logPointCut2()")
    public void around2(ProceedingJoinPoint point) {
    ...
    private void saveLog(ProceedingJoinPoint joinPoint, long time) {
        ...
        SysLogEntity sysLogBO = new SysLogEntity();
